<template>
  <div class="flex items-center justify-between w-4/5 max-w-6xl py-10">
    <div class="w-28 lg:w-36">
      <img class="w-full" src="@/assets/images/logo_white.svg" alt="logo">
    </div>
    ...
    <div class="flex">
      <ul class="flex list-none">
        ...
        <li
          @click="handleLogout"
          class="px-6 py-2 mr-2 font-bold bg-white rounded-full cursor-pointer text-brand-main focus:outline-none">
          {{ logoutLabel }}
        </li>
      </ul>
    </div>
